...
import { BulbContextProvider, BulbContext } from "./BcP.jsx";
...
function App() {
    ...
    return (
        // ths is wrapping of a compoennt with a provider , , from here  all compoent inside light compoentn can acces the 
        // bulbcontex  we created 
        <BulbContextProvider>
            <Light />
        </BulbContextProvider>
